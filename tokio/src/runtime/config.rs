...
pub(crate) struct Config {
    ...
    /// How many ticks when yielding to the driver for timer and I/O events?
    ...
    /// The multi-threaded scheduler includes a per-worker LIFO slot used to store the last scheduled task.
    /// This can improve certain usage patterns, especially message passing between tasks.
    /// However, this LIFO slot is not currently stealable.
    ///
